...
#else
        public static IEnumerable<IEdge> CreateHull(IEnumerable<IPoint> points) => points.Zip(points.Skip(1).Concat(new[] { points.FirstOrDefault() }), (a, b) => new Edge(0, a, b)).OfType<IEdge>();
#endif
